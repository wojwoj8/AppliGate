        ...
        <>
            ...
            <>
                ...
                <div className={"col-md-auto row d-flex align-items-center align-items-baseline flex-column me-md-1 "}>
                    ...
                    <div className="mt-2">
                        <div className="row rounded-3 p-2" style={{background: jobOfferTopColors?.background_color}}>
                            <div className="col-auto d-flex align-items-center ps-0">
                            <svg className="not-hidden pe-2 " width="48" height="48" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
