            ...
            <>
                <div className="row gy-4 row-cols-md-2 d-flex align-items-center">
                    <div className="d-flex align-items-center">
                        <div className="bg-danger ">
                            <svg className="not-hidden" width="54" height="54" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#ffffff" d="M12 20a8 8 0 0 0 8-8a8 8 0 0 0-8-8a8 8 0 0 0-8 8a8 8 0 0 0 8 8m0-18a10 10 0 0 1 10 10a10 10 0 0 1-10 10C6.47 22 2 17.5 2 12A10 10 0 0 1 12 2m.5 5v5.25l4.5 2.67l-.75 1.23L11 13V7h1.5Z"/>
                            </svg>
                        </div>
                    ...
                    <div className="d-flex align-items-center">
                        <div className="bg-danger ">
                            <svg className="not-hidden" width="54" height="54" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <g id="evaPinOutline0">
                                    <g id="evaPinOutline1">
                                        <g id="evaPinOutline2" fill="currentColor">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="bg-danger ">
                            <svg className="not-hidden" width="54" height="54" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#ffffff" d="M4 19V8v11v-.375V19Zm0 2q-.825 0-1.413-.588T2 19V8q0-.825.588-1.413T4 6h4V4q0-.825.588-1.413T10 2h4q.825 0 1.413.588T16 4v2h4q.825 0 1.413.588T22 8v4.275q-.45-.325-.95-.563T20 11.3V8H4v11h7.075q.075.525.225 1.025t.375.975H4Zm6-15h4V4h-4v2Zm8 17q-2.075 0-3.538-1.463T13 18q0-2.075 1.463-3.538T18 13q2.075 0 3.538 1.463T23 18q0 2.075-1.463 3.538T18 23Zm.5-5.2V15h-1v3.2l2.15 2.15l.7-.7l-1.85-1.85Z"/>
                            </svg>
                        </div>
                        <div className="ms-2">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="bg-danger ">
                            <svg className="not-hidden" width="54" height="54" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#ffffff" d="M30 30h-8V4h8zm-6-2h4V6h-4zm-4 2h-8V12h8zm-6-2h4V14h-4zm-4 2H2V18h8z"/>
                            </svg>
                        </div>
                        <div className="ms-2">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="bg-danger ">
                            <svg className="not-hidden" width="54" height="54" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#ffffff" d="M8 12h8v2H8v-2m2 8H6V4h7v5h5v3.1l2-2V8l-6-6H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h4v-2m-2-2h4.1l.9-.9V16H8v2m12.2-5c.1 0 .3.1.4.2l1.3 1.3c.2.2.2.6 0 .8l-1 1l-2.1-2.1l1-1c.1-.1.2-.2.4-.2m0 3.9L14.1 23H12v-2.1l6.1-6.1l2.1 2.1Z"/>
                            </svg>
                        </div>
                        <div className="ms-2">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="bg-danger ">
                            <svg className="not-hidden" width="54" height="54" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill="currentColor" d="M17 9h2V7h-2v2Zm0 4h2v-2h-2v2Zm0 4h2v-2h-2v2Zm0 4v-2h4V5h-9v1.4l-2-1.45V3h13v18h-6ZM1 21V11l7-5l7 5v10H9v-5H7v5H1Zm2-2h2v-5h6v5h2v-7L8 8.45L3 12v7Zm14-9Zm-6 9v-5H5v5v-5h6v5Z"/>
                            </svg>
                        </div>
                        <div className="ms-2">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="bg-danger ">
                            <svg className="not-hidden" width="54" height="54" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M402 168c-2.93 40.67-33.1 72-66 72s-63.12-31.32-66-72c-3-42.31 26.37-72 66-72s69 30.46 66 72Z"/>
                                <path fill="none" stroke="#ffffff" stroke-miterlimit="10" stroke-width="32" d="M336 304c-65.17 0-127.84 32.37-143.54 95.41c-2.08 8.34 3.15 16.59 11.72 16.59h263.65c8.57 0 13.77-8.25 11.72-16.59C463.85 335.36 401.18 304 336 304Z"/>
                                <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M200 185.94c-2.34 32.48-26.72 58.06-53 58.06s-50.7-25.57-53-58.06C91.61 152.15 115.34 128 147 128s55.39 24.77 53 57.94Z"/>
                                <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M206 306c-18.05-8.27-37.93-11.45-59-11.45c-52 0-102.1 25.85-114.65 76.2c-1.65 6.66 2.53 13.25 9.37 13.25H154"/>
                            </svg>
                        </div>
                        <div className="ms-2">
